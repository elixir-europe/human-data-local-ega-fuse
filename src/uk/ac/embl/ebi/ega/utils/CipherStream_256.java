 ...
 * This class is used by the Secure FTPS Server to unencrypt and then 
 * re-encrypt BAM files during an FTP download.
 ...
 * @author asenf
 */
public class CipherStream_256 extends Thread {
    ...
    public CipherStream_256(InputStream in, OutputStream out, int blocksize, char[] password, boolean mod) {
        this(in, out, blocksize, password, mod, 128); // Default password strength = 128
    }
    public CipherStream_256(InputStream in, OutputStream out, int blocksize, char[] password, boolean mod, int pw_strength) {
        ...
        try {
            ...
            if (mod) { // encrypt -- randomly generate
                ...
                try {
                    ...
                    Logger.getLogger(CipherStream_256.class.getName()).log(Level.SEVERE, null, ex);
                }
